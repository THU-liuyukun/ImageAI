...
public class ColorEnhance extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBar statusBar = new StatusBar(ColorEnhance.this);
        statusBar.setColor(R.color.transparent);

        setContentView(R.layout.color_enhance);
